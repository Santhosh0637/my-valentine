...
function App() {
  ...
  useEffect(() => {
    let i = 0;
    const text = config.content.title;
          ...
          {allGiftsOpened ? (
            <div className="all-gifts-opened">
              ...
              <p className="all-gifts-text">
                ...
                LOVE YOU SO MUCH Kal Nenja Kaari!❤️
              </p>
            </div>
          ) : (
            <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="ask"> {displayedTitle}</span>
        ...
        <motion.button
          className="btn reason-btn"
          onClick={() => {
            const reasons = config.reasons || ["You are amazing!"];
          ...
          >
            <motion.div
              ...
              style={{
                ...
                width: "400px",
                textAlign: "center",
                boxShadow: "0 10px 25px rgba(255, 77, 141, 0.3)",
                border: "4px solid #ffc0cb"
              }}
            >
              <h2 style={{ color: "#ff4d8d", marginBottom: "1rem" }}>Reason #{Math.floor(Math.random() * 100) + 1}</h2>
              <p style={{ fontSize: "1.4rem", lineHeight: "1.6", fontWeight: "500" }}>{currentReason}</p>
              <button
                onClick={() => setShowReason(false)}
                style={{
                  marginTop: "1.5rem",
        ...
        {showSecret && (
          ...
          >
            ...
            >
              <h2 style={{ color: "#ff4d8d", marginBottom: "1rem" }}>Shh! Use Secret Message 🤫</h2>
              <p style={{ fontSize: "1.2rem", lineHeight: "1.6" }}>{config.secret?.message}</p>
              <button
                onClick={() => setShowSecret(false)}
                style={{
                  marginTop: "1.5rem",
